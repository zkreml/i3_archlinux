...
package_name="autotiling picom imagewriter ttf-openlogos-archupdate nerd-fonts-complete ttf-firacode-nerd ttf-jetbrains-mono-nerd ttf-hack-nerd arc-gtk-theme"
