...
pacman_packages="noto-fonts-emoji firefox hplip gutenprint foomatic-db vim git htop darktable geeqie smplayer fzf zsh-syntax-highlighting zsh-autosuggestions vlc thunar pcmanfm thunar-archive-plugin xclip transmission-gtk libreoffice-fresh libreoffice-fresh-cs gnome-calculator pluma p7zip unrar tar rsync cryfs rapid-photo-downloader gthumb gimp wireguard-tools  nextcloud-client  flatpak catfish totem borg borgmatic gnome-disk-utility gparted python-llfuse sshfs simple-scan evince  geany gnome-screenshot filezilla networkmanager-openvpn passff-host  firefox-i18n-cs thunderbird thunderbird-i18n-cs wget yajl bitwarden cronie  noto-fonts-extra  picom pacman-contrib seahorse volumeicon neovim xdg-utils xdg-user-dirs-gtk unzip pavucontrol network-manager-applet noto-fonts ttf-dejavu file-roller"
